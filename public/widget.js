(function () {
  ...
  function init(options) {
    ...
    wrapper.innerHTML = [
      ...
      ".brainai-bubble{position:relative;max-width:260px;border:2px solid #e5e7eb;background:#fff;color:#111827;border-radius:18px 18px 18px 18px;padding:12px 20px;font:700 14px/1.35 inherit;box-shadow:0 12px 35px rgba(0,0,0,.15);text-align:center;transition:all 0.3s ease;}.brainai-bubble::after{content:'';position:absolute;bottom:-12px;right:18px;border-left:10px solid transparent;border-right:4px solid transparent;border-top:12px solid #fff;filter:drop-shadow(0 2px 0 #e5e7eb);}",
