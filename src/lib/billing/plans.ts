...
export const PLAN_LIMITS = {
  ...
  STARTER: {
    ...
    name: 'Starter',
    price: 1499,
    annual_price: 9999,   // ₹833/month billed annually
    ...
    automation: '10 workflows, max 15 steps, 1,000 runs/day',
    ai_engine: 'Gemini 2.5 Flash Lite',
    ai_label: 'B9 Agentic Core',
    badge: null,
    features: [
      ...
      '10 automations (15 steps each)',
      'IndiaMART sync included',
      'QR Code generator included',
      '100 leads/day, 2 team members',
